...
const EditShipModal = ({ isOpen, onClose, onEditShip, selectedShip }) => {
  const [updatedShipData, setUpdatedShipData] = useState(selectedShip);
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "cargas") {
      ...
      setUpdatedShipData({ ...updatedShipData, [name]: selectedOptions });
    } else {
      setUpdatedShipData({ ...updatedShipData, [name]: value });
    }
  };
  ...
  const handleEditShip = () => {
    onEditShip(selectedShip.id, updatedShipData);
    handleModalClose();
  };
        ...
        <ModalBody>
          ...
          <Stack flexDirection="row" mb="1rem">
            ...
            <FormControl>
              ...
              <Input
                name="clientes"
                value={updatedShipData.clientes}
                onChange={handleInputChange}
              />
            </FormControl>
            <FormControl>
              ...
              <Input
                name="operadores"
                value={updatedShipData.operadores}
                onChange={handleInputChange}
              />
            </FormControl>
          </Stack>
            ...
            <Stack flexDirection="row" mb="1rem">
              <FormControl>
                ...
                <Input
                  ...
                  value={updatedShipData.pesoManifestado}
                  onChange={handleInputChange}
                />
              </FormControl>
              ...
              <FormControl>
                ...
                <Input
                  ...
                  value={updatedShipData.unidadeManifestada}
                  onChange={handleInputChange}
                />
              </FormControl>
              <FormControl mb="1rem">
          ...
          <FormControl>
            ...
            <Select
              ...
              name="operacao"
              value={updatedShipData.operacao}
              onChange={handleInputChange}
            >
              <option>Carga</option>
          ...
          <FormControl>
            ...
            <Input
              type="datetime-local"
              name="etaNor"
              value={updatedShipData.etaNor}
              onChange={handleInputChange}
            />
          </FormControl>
        </ModalBody>
        <ModalFooter>
          <Button colorScheme="blue" mr={3} onClick={handleEditShip}>
            Atualizar
          </Button>
